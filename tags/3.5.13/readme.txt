...
3.5.12 - Implemented encoding\decoding url when not using advanced options. Should solve 404 problem in some cases.
3.5.13 - Undo some changes in 3.5.12 which produced 404 error.
