...
class wp_noexternallinks
{
    ...
    function GetOptionInfo()
    {
        return array(
            ...
            array('old_name' => 'noexternallinks_exclude_links', 'new_name' => 'exclude_links', 'def_value' => '', 'type' => 'text', 'name' => __('Exclude URLs that you don`t want to mask (all urls, beginning with those, won`t be masked). Put one adress on each line, including protocol prefix (for example,', 'wp-noexternallinks') . ' "<b>http://</b>jehy.ru" ' . __('or', 'wp-noexternallinks') . ' <b>https://</b>google.com ' . __('or', 'wp-noexternallinks') . ' <b>ftp://</b>microsoft.com). ' .'<br>'. __('Skype, javascript and mail links are excluded by default. To exclude full protocol, just add line with it`s prefix - for example,', 'wp-noexternallinks') . ' "<b>ftp://</b>" '.'<br>'. __('Please note that domains with "www" and without it are considered different. So if you want to disable masking for "pinterest.com" and "www.pinterest.com", you should specify both domains', 'wp-noexternallinks'), 'grp' => 'exclude'),
